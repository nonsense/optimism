...
impl<DB: Database, I, P> OpEvm<DB, I, P> {
    ...
    pub const fn new(
        ...
        Self { inner: evm, inspect, last_tx_warming_savings: 0 }
    }
    ...
    P: PrecompileProvider<OpContext<DB>, Output = InterpreterResult>,
{
    ...
    fn transact_raw(
        ...
        self.last_tx_warming_savings = self.inner.0.ctx.journaled_state.take_last_tx_warming_savings();
...
impl EvmFactory for OpEvmFactory {
    ...
    fn create_evm<DB: Database>(
        ...
        OpEvm { inner, inspect: false, last_tx_warming_savings: 0 }
    }
    ...
    fn create_evm_with_inspector<DB: Database, I: Inspector<Self::Context<DB>>>(
        ...
        OpEvm { inner, inspect: true, last_tx_warming_savings: 0 }
    }
}
